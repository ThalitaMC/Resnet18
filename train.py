...
if args['model'] == 'scratch':
    ...
    model = ResNet(img_channels=3, num_layers=18, block=ResBlock, num_classes=4).to(device)
    plot_name = 'resnet_scratch'
    folder = 'C:\\Users\\thali\\Resnet18\\Resnet18\\outputs'
    torch.save(model.state_dict(), 'model_weights.pth')
if args['model'] == 'torchvision':
    print('[INFO]: Training the Torchvision ResNet18 model...')
    model = build_model(pretrained=False, fine_tune=True, num_classes=4).to(device) 
